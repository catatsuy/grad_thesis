...
\fi
But the architectural simulation speed of Verilog HDL is slow. It was difficult to design architectural design.
...
\fi
In this paper, I aim to speed up ArchHDL.
...
(2) storing as an array value to devise a memory allocation,
(3) parallelization.
...
\fi
When I evaluated 4096 of the counters circuit as a micro benchmark,
elapsed time of the proposed methods is 5.23 times faster than that of the original ArchHDL.
When I evaluated a stencil-computation circuit as a realistic hardware,
elapsed time of the proposed methods is 1.95 times faster than that of the original ArchHDL.
The results show that ArchHDL applied the proposed methods can perform faster than VCS in the all evaluations in this paper.