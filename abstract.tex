...
ArchHDL treats a registers as a variable and wires as a function.
...
(3) parallelization.
I propose and implement a fast method of the three.
...
\fi
When I evaluated using 4096 of the counter circuit which is a micro benchmark,
the proposed method is 5.23 times faster than the original ArchHDL.
When I evaluated using a stencil-computation circuit which is a realistic hardware,
the proposed method is 1.95 times faster than the original ArchHDL.
The proposed method can be performed faster than VCS in the all evaluations here.