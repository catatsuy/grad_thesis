...
In the 6th line of \figref{src:counter}, the lambda function (\texttt{[=]() \{ return counter(); \}}) which returns a value of \textit{reg counter} is assigned to the \textit{wire out}.
