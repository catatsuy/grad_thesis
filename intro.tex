...
It is faster than that with NC-Verilog which is verilog simulators and proprietary software.
However, it is not faster than that with VCS which is the fastest in the verilog simulators and proprietary software in some hardware simulation.
