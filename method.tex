...
\section{高速化の方針}
\fi
\section{A Direction of Speeding up}

\if0
高速化の方針として逐次プログラミングにおける最適化と並列化の両方を考える．
\fi
I consider both optimizations in sequential programming and parallelization
as a policy of the methods for high speed simulation.

\if0
\section{逐次プログラムにおける高速化手法}
\fi
\section{Proposed methods can perform faster with sequential program}
...
\fi
I have been considering the methods in sequential programming.
