...
Big frame on the left denotes \textit{registers\_} of \verb`std::vector` in the line 18 of \figref{src:class_singleton}.
...
\fi
I describe the proposed method.
I parallelize \textit{Module::Always} and \textit{reg::Update} method in the line from 41 to 43 in \figref{src:class_singleton}.
...
\fi
\figref{src:exec_openmp} is an improvement on \figref{src:class_singleton} in the line from 40 to 47.
...
The line 2 of \figref{src:exec_openmp} give parallelization in 8 threads.
The line 4 and the line 8 are OpenMP directives to parallelize the execution of the \textit{for} statement.
