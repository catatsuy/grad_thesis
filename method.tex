...
\fi
\subsection{Devising a Memory is stored as an array value} \label{sss:mem_copy}
...
It denotes \figref{src:class_singleton} from 44th line to 46th line.
...
A solid arrow represents the assignment.
A dotted arrow represents a pointer reference.
